...
class ThreadOnlineConnect extends Thread {
	...
	public void run() {
		try {
			...
			Session joiningSession = this.field_96594_c.func_96578_b().session;
			String cmcTokenPayload = joiningSession.cmcAccessToken != null ? joiningSession.cmcAccessToken : "";
			TaskOnlineConnect.func_96580_a(this.field_96594_c).addToSendQueue(new Packet2ClientProtocol(61, joiningSession.username, this.field_96595_a, this.field_96593_b, cmcTokenPayload));
