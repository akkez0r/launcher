...
class ThreadConnectToServer extends Thread {
	...
	public void run() {
		try {
			...
			Session joiningSession = GuiConnecting.func_74254_c(this.connectingGui).session;
			String cmcTokenPayload = joiningSession.cmcAccessToken != null ? joiningSession.cmcAccessToken : "";
			GuiConnecting.getNetClientHandler(this.connectingGui).addToSendQueue(new Packet2ClientProtocol(61, joiningSession.username, this.ip, this.port, cmcTokenPayload));
