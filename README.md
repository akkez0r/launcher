...
- Or set a GitHub repo/zip URL and use **Download Minecraft** in the launcher.
- If launch path is missing, launcher will try auto-downloading from configured GitHub URL.
